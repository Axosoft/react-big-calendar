...
var propTypes = {
  ...
  handleOnHideOverlay: _propTypes2.default.func,
...
var MonthView = (function(_React$Component) {
  ...
  MonthView.prototype.onHideOverlay = function onHideOverlay() {
  ...
  MonthView.prototype.renderOverlay = function renderOverlay() {
    ...
    var _props2 = this.props,
      ...
      handleOnHideOverlay = _props2.handleOnHideOverlay

    var PopupComponent = components.popup || _Popup2.default
      ...
      _Overlay2.default,
      {
        ...
        onHide: function onHide() {
          if (handleOnHideOverlay) {
            return handleOnHideOverlay(_this3.onHideOverlay)
          } else {
            _this3.onHideOverlay()
          }
        },
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderWeek = function(week, weekIdx) {
    var _props3 = _this4.props,
      ...
      tooltipAccessor = _props3.tooltipAccessor,
      ...
      dayPropGetter = _props3.dayPropGetter,
  ...
  this.handleShowMore = function(events, date, cell, slot) {
    var _props5 = _this4.props,
      popup = _props5.popup,
      onDrillDown = _props5.onDrillDown,
      onShowMore = _props5.onShowMore,
